...
class MicrosoftTranslator {
    ...
    /**
     * Service root URL for translation. You can get it from Microsoft Azure Dataset PAge
     *
     * @var unknown_type
     */
     ...
     */
    private $accountKey = 'iu1Hv8j6p3lQwC+fUjpG2+gqQ0xJtnK2yasYCviQp3k';
    ...
    public function getLanguages() {
        ...
        $objResponse = json_decode($response);
        $availableLang = array();
        foreach ($objResponse->d->results as $values) {
            $availableLang[] = $values->Code;
        }

        if (!empty($availableLang) && isset($availableLang)) {
